...
{
    /// <inheritdoc />
    public partial class libMiratin2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentBookId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Books_StudentBooks_StudentBookId",
                        column: x => x.StudentBookId,
                        principalTable: "StudentBooks",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Books_Students_StudentsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Books_StudentBookId",
                table: "Books",
                column: "StudentBookId");

            migrationBuilder.CreateIndex(
                name: "IX_Books_StudentsId",
                table: "Books",
                column: "StudentsId");
